    ...
    value: function parse() {
      ...
      return new Promise(function (resolve, reject) {
        _this2.getEntries([ManifestName, ResourceName]).then(function (buffers) {
          ...
          var apkInfo = _this2._parseManifest(buffers[ManifestName]); // 解析 resourcemap
          ...
          if (!buffers[ResourceName]) {
            ...
            // 解析 resourcemap
            resourceMap = _this2._parseResourceMap(buffers[ResourceName]); // 结合resourcemap再次解析apkInfo

            apkInfo = mapInfoResource(apkInfo, resourceMap); // 获取icon base64值
